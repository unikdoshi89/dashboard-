...
function JiraDetails() {
  ...
  async function loadFeatures(
    ...
    try {
      ...
      console.error(
        "Unable to load Jira features/stories:",
        err
      );
  ...
  async function handleSaveConfig() {
    try {
      ...
      if (prodLabels.length === 0) {
        setConfigError(
          "At least one Production issue label is required."
        );
        return;
      }
